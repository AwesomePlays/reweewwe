...
const commands = {
    ...
    "fire": (msg) => {
      ...
      if (msg.mentions.members.first().id == 251664182116614144)
          return msg.reply("<a:pika:714410716983197818> You do not have sufficient permissions to fire this user. This user created me.")
      if(msg.member.highestRole.comparePositionTo(msg.mentions.members.first().highestRole) < 0){
    //member has higher role then first mentioned member
            ...
            if (msg.mentions.members.first()) {
              ...
              if (warningReason !== undefined) {
                ...
                if (warningReason !== "") {
                    ...
                    rMember.removeRoles(rMember.roles.filter(role => role.id!='653368896166035456'/*Member Role*/ && role.id!='708160554187096066' /*Sale's Respect Role*/ && role.id!='691704235859116052' /*Blacklisted from Events Role*/ && role.id!='708682769315659787' /*Nice Guy/Girl Role*/ && role.id!='683768172645711873' /*Announcement Ping Role*/ && role.id!='683768024754290723' /*Giveaway Ping Role*/ && role.id!='683768008191377485' /*Poll Ping Role*/ && role.id!='683767807560908904' /*Event Ping Role*/ && role.id!='683549674178609158' /*News Ping Role*/ && role.id!='663139062395437077' /*Giveaway Role*/ && role.id!='654520879148957706' /*QOTD Role*/ && role.id!='704997753557876866' /*Blacklisted from Staff Role*/ && role.id!='656325225767632926' /*Muted Role*/ && role.id!='692090066268323881' /*Ban from Counting Role*/ && role.id!='698623244349079593' /*Hired Operative Role*/ && role.id!='653369084087500810' /*Cool Person Role*/ && role.id!='654157886968037406' /*Try Hard Role*/ && role.id!='661459961943162880' /*Advertiser Role*/ && role.id!='657011680596983809' /*Rich Role*/ && role.id!='653369129805545513' /*Royalty Role*/ && role.id!='653421234750619648' /*Trusted Role*/ && role.id!='679355971323166751' /*Meme Lord Role*/ && role.id!='692399778692071434' /*Verified Role*/ && role.id!='690426616198987787' /*Image Perms Role*/)).then(console.log).catch(console.error); //Removes all roles
